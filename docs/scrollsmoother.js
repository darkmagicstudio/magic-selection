  ...
  function ScrollSmoother(e) {
    ...
    Ta(),
      ...
      (this.scrollTo = function (e, t, r) {
        ...
        t
          ? u
            ? I.to(o, { duration: C, scrollTop: n, overwrite: "auto", ease: j })
            : _(n)
          : Oa(n);
      }),
        ...
        return arguments.length
          ? ((m =
              ...
              (function _wrap(e) {
                ...
                return (
                  t ||
                    ((t = W.createElement("div")).classList.add(
    ...
    L.forEach(function (e) {
      ...
      (this.kill = this.revert = function () {
        ...
        for (var e = (v || []).concat(s || []), t = e.length; t--; )
          e[t].kill();
        V.scrollerProxy(m),
      ...
      x &&
        (this.normalizer = V.normalizeScroll(
          !0 === x ? { debounce: !0, content: !C && n } : x
        )),
      V.config(e),
      "overscrollBehavior" in N.getComputedStyle(F) &&
        I.set([F, B], { overscrollBehavior: "none" }),
      "scrollBehavior" in N.getComputedStyle(F) &&
        I.set([F, B], { scrollBehavior: "auto" }),
